...
class login_system:
    ...
    # Create Widgets
        ...
        self.user_icon=ImageTk.PhotoImage(file=r"l1.png")
    ...
    def login(self):
        ...
        for row in result1:
             ...
             id=str(row[0])
             print(id)
             with open(r"D:\VAISHNAVI GROUPS (501-550)\22C9505 Image and text deduplication\100%code\Image_and_text_Encryption\id.txt", 'w') as f:
